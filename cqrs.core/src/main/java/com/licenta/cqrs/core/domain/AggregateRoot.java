package com.licenta.cqrs.core.domain;

import com.licenta.cqrs.core.events.BaseEvent;
import com.licenta.vote.CustomExceptions.DateFormatIncorrectException;
...
public abstract class AggregateRoot {
    ...
    protected void applyChange(BaseEvent event, Boolean isNewEvent){
        try {
            ...
            if (e.getCause() instanceof DateFormatIncorrectException) {
                throw (DateFormatIncorrectException) e.getCause();
            } else {
