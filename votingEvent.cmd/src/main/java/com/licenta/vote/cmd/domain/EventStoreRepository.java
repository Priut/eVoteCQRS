...
public class EventStoreRepository  {
    ...
    public List<VotingEventModel> findByAggregateIdentifier(String aggregateIdentifier, String collectionName) {
        Query query = new Query();
        query.addCriteria(Criteria.where("aggregateIdentifier").is(aggregateIdentifier));
        return mongoTemplate.find(query, VotingEventModel.class, collectionName);
    }
    public List<VotingEventModel> findAll(String collectionName) {
        return mongoTemplate.findAll(VotingEventModel.class, collectionName);
    }
}
