...
@Service
public class VotingEventEventSourcingHandler implements EventSourcingHandler<VotingEventAggregate> {
    @Autowired
    ...
    @Override
    public VotingEventAggregate getById(String id) {
        var aggregate = new VotingEventAggregate();
